...
const PostJobForm = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow">
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">1. Job Information</h2>
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">2. Job Description</h2>
