...
//   const navItems = [
//     { path: '/evaluator/assessments', name: 'My Assessments', icon: <FiClipboard /> },
//     { path: '/evaluator/completed', name: 'Completed Evaluations', icon: <FiCheckCircle /> }
//   ];

//   return (
//     <div className="min-h-screen bg-gray-50">
//       {/* Green-themed header with animations */}
//       <motion.nav 
...
//             <p className="text-gray-600 mb-6">You have 3 pending evaluations to complete.</p>
...
//               >
//                 <h3 className="font-medium text-lg text-green-600 flex items-center">
//                   <FiClipboard className="mr-2" /> Recent Evaluations
//                 </h3>
//                 <ul className="mt-2 space-y-2">
//                   <li className="text-gray-700">CS-401: Advanced Programming</li>
//                   <li className="text-gray-700">CS-305: Database Systems</li>
//                 </ul>
//               </motion.div>
...
//               >
//                 <h3 className="font-medium text-lg text-green-600 flex items-center">
//                   <FiCheckCircle className="mr-2" /> Completed Evaluations
//                 </h3>
//                 <ul className="mt-2 space-y-2">
//                   <li className="text-gray-700">CS-201: Data Structures</li>
//                   <li className="text-gray-700">CS-101: Intro to Programming</li>
//                 </ul>
//               </motion.div>
//             </div>
...
//               whileTap={{ scale: 0.98 }}
//               className="mt-6 px-4 py-2 bg-green-600 rounded-md text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
//               onClick={() => navigate('/evaluator/assessments')}
//             >
